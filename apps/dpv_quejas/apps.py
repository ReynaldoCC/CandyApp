...
class DpvQuejaConfig(AppConfig):
    name = 'apps.dpv_queja'  # Nombre identificador del modulo tiene que cumplir con el estandar
    verbose_name = "Quejas"  # Nombre de Humanizado del modulo sera utilizado para mostrar en el menu
    menu = 'dpv_queja/menu/main_menu.html'  # Plantilla HTML de que se mostrara el modulo del menu
    ...
    route_data = 'queja' # ruta principal del modulo