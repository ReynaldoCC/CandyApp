...
var DPVNivelSolucionNom =  function () {
    let nivelsolucion_form;
    let validator_form;

    const _initNivelSolucionPane = function (translations) {
    ...
    const _initNivelSolucionForm =  function () {
        ...
        validator_form = nivelsolucion_form.validate({
			...
			messages: {
				nombre: {
				    maxlength: "El nombre del nivel de solución no puede tener más de 40 caracteres.",
				    required: "El nombre del nivel de solución es obligatorio.",
                    letterswithbasicpuncandspace: "El nombre del nivel de solución solo puede tener letras, números, y signos de puntuación básicos.",
                    remote: "Ya existe otro nivel de solución registrado con ese nombre.",
				},
				codigo: {
				    maxlength: "El código no puede tener más de 3 caracteres.",
				    required: "El código es obligatorio.",
                    letterswithbasicpuncandspace: "El código solo puede tener letras y números",
                    remote: "Ya existe otro nivel de solución registrado con ese código.",
				},
			},
		});
    };
    ...
    return {
        init: function (translations) {
            _initNivelSolucionPane(translations);
        },
        initForm: function () {
            nivelsolucion_form = $('#form_nivelsolucion');
            _initNivelSolucionForm();
        },
    }
}();